<!-- Vendored from proyecto26/system-design-skills @ a70772efb956e8c9b78ef5b7538dee00cc3b9263 (2026-06-02, MIT), renamed METHOD.md here. The frontmatter below is upstream's own skill metadata (name: requirements-scoping) — it is not a live, separately-installed skill; see references/vendor/VENDOR.md. Do not edit; re-vendor deliberately after auditing the upstream diff. -->
---
